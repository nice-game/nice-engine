...
pub struct GGD_RenderEngine {
	...
	pub ImageData_GetCacheData: Option<extern fn (image: *mut GGD_ImageData, buffer: *mut c_void, size: *mut u32) -> i32>,
	pub ImageData_SetPixelData: extern fn (image: *mut GGD_ImageData, buffer: *const c_void, x: u32, y: u32, format: GGPixelFormat),
	pub ImageData_GetPixelData: extern fn (image: *mut GGD_ImageData, buffer: *mut c_void, x: *mut u32, y: *mut u32, format: *mut GGPixelFormat),
	pub ImageData_DrawCamera: extern fn (dst: *mut GGD_ImageData, src: *mut GGD_Camera),
	pub ImageData_DrawImage: extern fn (dst: *mut GGD_ImageData, src: *mut GGD_ImageData, x: f32, y: f32, w: f32, h: f32),
	pub ImageData_DrawText: extern fn (dst: *mut GGD_ImageData, src: *mut GGD_FontData, x: f32, y: f32, text: *const char),
	...
	pub FontData_SetTTFData: Option<extern fn (image: *mut GGD_FontData, buffer: *const c_void, bytes: u32, fontsize: u32, r: f32, g: f32, b: f32)>,
