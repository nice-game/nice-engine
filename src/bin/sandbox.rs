...
pub fn main() {
	...
	let (triangle, triangle_future) = MeshData::new(
		&ctx,
		[
			Pntl_32F { pos: [-1.0, -1.0, 0.0], nor: [0.0, 0.0, 1.0], tex: [0.0, 0.0], lmap: [0.0; 2] },
			Pntl_32F { pos: [1.0, -1.0, 0.0], nor: [0.0, 0.0, 1.0], tex: [1.0, 0.0], lmap: [0.0; 2] },
			Pntl_32F { pos: [1.0, 1.0, 0.0], nor: [0.0, 0.0, 1.0], tex: [1.0, 1.0], lmap: [0.0; 2] },
			Pntl_32F { pos: [-1.0, 1.0, 0.0], nor: [0.0, 0.0, 1.0], tex: [0.0, 1.0], lmap: [0.0; 2] },
		],
